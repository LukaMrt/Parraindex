...
**Parraindex** est une application web moderne développée avec Symfony 7.2 et PHP 8.4. Elle gère les relations de parrainage entre étudiants de l'IUT Lyon 1.
...
**Score Global**: **5.6/10** - Projet fonctionnel avec de bonnes bases mais nécessitant des améliorations significatives.
